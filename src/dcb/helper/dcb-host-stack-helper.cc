...
void
DcbHostStackHelper::EnablePcapIpv4Internal(std::string prefix,
                                           Ptr<Ipv4> ipv4,
                                           uint32_t interface,
                                           bool explicitFilename)
{
    ...
    if (!PcapHooked(ipv4))
    {
        ...
        NS_ASSERT_MSG(ipv4L3Protocol,
                      "DcbHostStackHelper::EnablePcapIpv4Internal(): "
...
void
DcbHostStackHelper::EnablePcapIpv6Internal(std::string prefix,
                                           Ptr<Ipv6> ipv6,
                                           uint32_t interface,
                                           bool explicitFilename)
{
    ...
    if (!PcapHooked(ipv6))
    {
        ...
        NS_ASSERT_MSG(ipv6L3Protocol,
                      "DcbHostStackHelper::EnablePcapIpv6Internal(): "
...
void
DcbHostStackHelper::EnableAsciiIpv4Internal(Ptr<OutputStreamWrapper> stream,
                                            std::string prefix,
                                            Ptr<Ipv4> ipv4,
                                            uint32_t interface,
                                            bool explicitFilename)
{
    ...
    if (stream == 0)
    {
        ...
        if (!AsciiHooked(ipv4))
        {
            ...
            NS_ASSERT_MSG(result == true,
                          "DcbHostStackHelper::EnableAsciiIpv4Internal():  "
...
void
DcbHostStackHelper::EnableAsciiIpv6Internal(Ptr<OutputStreamWrapper> stream,
                                            std::string prefix,
                                            Ptr<Ipv6> ipv6,
                                            uint32_t interface,
                                            bool explicitFilename)
{
    ...
    if (stream == 0)
    {
        ...
        if (!AsciiHooked(ipv6))
        {
            ...
            NS_ASSERT_MSG(result == true,
                          "DcbHostStackHelper::EnableAsciiIpv6Internal():  "
