...
void
DcbNetDeviceHelper::EnablePcapInternal(std::string prefix,
                                       Ptr<NetDevice> nd,
                                       bool promiscuous,
...
void
DcbNetDeviceHelper::EnableAsciiInternal(Ptr<OutputStreamWrapper> stream,
                                        std::string prefix,
                                        Ptr<NetDevice> nd,
                                        bool explicitFilename)
{
    ...
    if (stream == nullptr)
    {
        ...
        //
        asciiTraceHelper.HookDefaultReceiveSinkWithoutContext<DcbNetDevice>(device,
                                                                            "MacRx",
                                                                            theStream);
        ...
        // theStream); asciiTraceHelper.HookDefaultDropSinkWithoutContext<Queue<Packet> > (queue,
        // "Drop", theStream); asciiTraceHelper.HookDefaultDequeueSinkWithoutContext<Queue<Packet> >
        // (queue, "Dequeue", theStream);

        // // PhyRxDrop trace source for "d" event
        // asciiTraceHelper.HookDefaultDropSinkWithoutContext<DcbNetDevice> (device, "PhyRxDrop",
        // theStream);
